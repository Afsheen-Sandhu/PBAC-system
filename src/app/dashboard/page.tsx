  ...
  const availableSections = useMemo(() => {
    ...
    return (
      Object.values(SECTION_CONFIG)
        ...
        .filter((section): section is (typeof SECTION_CONFIG)[string] => Boolean(section))
    );
  }, [user?.permissions]);

  if (!user) {
    return (
      <div className="mx-auto mt-24 max-w-2xl rounded-lg border bg-card p-8 text-center shadow">
